...
{
    public static string ArgumentativeFilterTemplate(string containingNamespace, string containingClass, string factoryBody) => $@"// <auto-generated/>
using global::System;
...
{{
    ...
    {{
        public static EndpointFilterDelegate Factory(EndpointFilterFactoryContext context, EndpointFilterDelegate {VariableNames.EndpointFilterDelegate})
        {{
{factoryBody}

            return invocationFilterContext => next(invocationFilterContext);
        }}
...
";
    ...
    public static string HandlerArgumentGetterTemplate(string argumentName) => $@"
    int? {argumentName}Index = context.GetArgumentIndex({argumentName});
";
